            ...
            {groups.map((group) => (
              ...
              >
                ...
                <Box borderRadius="2xl" overflow="hidden" boxShadow="2xl" bg="gray.50">
                  <Image src={group.image} alt={t(group.titleKey)} w="full" h="450px" objectFit="cover" fallbackSrc="https://via.placeholder.com/400x500?text=Loading..." />
                </Box>
                  ...
                  {selectedGroup?.editions.map((item, idx) => (
                    <ListItem key={idx} p={4} bg="blue.50" borderRadius="xl">
                      <HStack spacing={4} align="center">
                        ...
                        <Text fontSize="md" fontWeight="medium" color="gray.800">{item.text}</Text>
                      </HStack>
                    </ListItem>
                  ))}
                </UnorderedList>
